...
## Data   
There are 7 samples where 5 belongs to Library2 and 2 to Library3
...
cd /proj/snic2022-22-672/private/SMS_6112_RNASeq_Bat_Library2_3/  
...
samples_info <- read.table(paste0(path, "data/sample_data_L2_3.tsv"), header=T, check.names=T, sep="\t")
...
exp <- readRDS("/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/R_Files/salmon.merged.gene_counts_length_scaled.rds")
exp2 <- exp
...
png(paste0(path, '/results/Library2_3_ALL/results/01_DE/PCA_bat_organ_L2_3.png'), width = 4000, height = 3000, res = 300)
...
ggplot(a, aes(x = PC1, y = PC2, color = organ, shape = bat)) + 
  geom_point(size = 4, alpha = 0.8) +
              ...
              labs(x="PC1: 57% variance", y = "PC2: 27% variance", element_text(face = "bold")) +
...
png(paste0(path, '/results/Library2_3_ALL/results/01_DE/HeatMap_rlog_L2_3.png'), width = 4000, height = 3000, res = 300)
...
#png(paste0(path, '/results/Library2_3_ALL/results/01_DE/HeatMap_topvar500_L1.png'), width = 4000, height = 15500, res = 300)
png(paste0(path, '/results/Library2_3_ALL/results/01_DE/HeatMap_topvar100_L2_3.png'), width = 4000, height = 8000, res = 300)
...
write.table(mat,file='/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/topVarGenes1000_L2_3.tsv',quote=FALSE,sep="\t")

##

png(paste0(path, '/results/Library2_3_ALL/results/01_DE/HeatMap_topvar100_clus_L2_3.png'), width = 5000, height = 8000, res = 300)

#png(paste0(path, '/results/Library2_3_ALL/results/01_DE/HeatMap_topvar500_clus_L1.png'), width = 5000, height = 15500, res = 300)
...
counts_differexp <- inner_join(counts_differexp, samples_info, 'sample_name')

png(paste0(path, '/results/Library2_3_ALL/results/01_DE/violim_topvar100_clus_L2_3.png'), width = 5000, height = 4000, res = 300)
...
png(paste0(path, '/results/Library2_3_ALL/results/01_DE/distribution_L2_3.png'), width = 3000, height = 2500, res = 300)
...
# Results  
## Filtering
We filter out low-count genes before downstream analysis by using at least 20 reads in total (including all samples) by which we removed 7032 genes and kept 20960 genes for downstream analysis. 

The distribution of normalized expression in all samples are shown in figure 1.  

```{r fig-1, echo = F, eval = T}
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/distribution_L2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/HeatMap_rlog_L2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/PCA_bat_organ_L2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/HeatMap_topvar100_L2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/HeatMap_topvar100_clus_L2_3.png')
```
...
tbl_top <- read.table("/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/topVarGenes1000_L2_3.tsv", header=T, row.names=1, check.names=T, sep="\t")
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/Library2_3_ALL/results/01_DE/gProfiler_mlucifugus_2022-12-21_10-39-26.png')
```

**Dinamic Link**

[GO Terms](https://biit.cs.ut.ee/gplink/l/Alm0lfaeTl) 
