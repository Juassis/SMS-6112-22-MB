...
png(paste0(path, '/results/ALL_Libraries/results/01_DE/violim_topvar100_clus_L1_2_3.png'), width = 5000, height = 4000, res = 300)
...
```{r volcano_intestine, eval = F, echo = T}

dds3 <- DESeqDataSetFromMatrix(countData = round(counts),
                              colData = samples_info,
                              design = ~ 0 + organ_bat)
dds3 <- DESeq(dds3)
resultsNames(dds3)
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/distribution_L1_2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/HeatMap_rlog_L1_2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/PCA_bat_organ_L1_2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/HeatMap_topvar100_L1_2_3.png')
```
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/HeatMap_topvar100_clus_L1_2_3.png')
```
...
```{r fig-topVarGenes-cluster-1000, echo = F, eval = T }
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/HeatMap_topvar1000_clus_L1.png')
```
...
tbl_top <- read.table("/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/topVarGenes1000_L1_2_3.tsv", header=T, row.names=1, check.names=T, sep="\t")
...
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/gProfiler_mlucifugus_2022-12-21_11-07-18.png')
```


```{r fig-topVarGenes-GO-2, echo = F, eval = T }
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/gProfiler_mlucifugus_2022-12-21_11-08-04.png')
```

**Dinamic Link**

[GO Terms](https://biit.cs.ut.ee/gplink/l/Ff9bRzi4TG) 


### DEseq Intestine

```{r fig-intestine_volcano, echo = F, eval = T }
knitr::include_graphics('/Users/juliana/Documents/GitHub/SMS-6112-22-MB/results/ALL_Libraries/results/01_DE/intestine_volcano_L1_2_3.png')
```
